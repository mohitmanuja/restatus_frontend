...
public class UCropActivity extends AppCompatActivity {
    ...
    private void processOptions(@NonNull Intent intent) {
        ...
        mOverlayView.setCropFrameStrokeWidth(intent.getIntExtra(UCrop.Options.EXTRA_CROP_FRAME_STROKE_WIDTH, getResources().getDimensionPixelSize(com.intuit.sdp.R.dimen._1sdp)));
        ...
        mOverlayView.setCropGridStrokeWidth(intent.getIntExtra(UCrop.Options.EXTRA_CROP_GRID_STROKE_WIDTH, getResources().getDimensionPixelSize(com.intuit.sdp.R.dimen._1sdp)));
