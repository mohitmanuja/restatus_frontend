                ...
                .addOnCompleteListener(this, task -> {
                    ...
                    if (task.isSuccessful()) {
                        ...
                        if (firebaseUser == null) {
                            Toast.makeText(this, "Login failed: Firebase user is null", Toast.LENGTH_SHORT).show();
                            return;
                        }
                        ...
                        Log.d("GoogleLogin", "Login success: " + email + ", name: " + displayName);

                        // ✅ Now call your backend API or ViewModel
                        ...
                        Toast.makeText(this, "Google Login Failed: " + (e != null ? e.getMessage() : ""), Toast.LENGTH_LONG).show();
                    }
                });
    }
