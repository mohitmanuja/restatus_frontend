package com.motivation.quotes.app.ui.utility;
...
public class ImageUtils {
    ...
    public static Bitmap getResampleImageBitmap(Uri uri, Context context) throws IOException {
        try {
            return com.motivation.quotes.app.ui.ImageUtils.getInstant().getCompressedBitmap(getRealPathFromURI(uri, context));
        } catch (Exception e) {
            e.printStackTrace();
            return null;
        }
